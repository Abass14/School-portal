	...
	if(isset($_SESSION['register'])){
		...
		if($result){
			...
			if($row[0]['authority'] == 'admin'){
				$menuPlus = '<a class="text-white sd-link" href="admin-staff-mgt.php"><li onmouseover="changeColor4()" onmouseleave="reverseColor4()" id="sd-link4" id="sd-link" class="sd-item">STAFF MANAGEMENT</li></a>
					...
					$menuPlus = '
						<a class="text-white sd-link" href="student-register.php"><li onmouseover="changeColor4()" onmouseleave="reverseColor4()" id="sd-link4" id="sd-link" class="sd-item">RESISTER COURSE</li></a>
						<a class="text-white sd-link" href="student-exam.php"><li onmouseover="changeColor5()" onmouseleave="reverseColor5()" id="sd-link5" id="sd-link" class="sd-item">SELECT EXAM</li></a>
						<a class="text-white sd-link" href="student-result"><li onmouseover="changeColor4()" onmouseleave="reverseColor4()" id="sd-link4" id="sd-link" class="sd-item">CHECK RESULT</li></a>';
		...
		$sidebar = '<div id="sd-bar" class="sd-bar">
						<ul class="ul-bar">
							...
							<a class="text-white sd-link" href="logout.php"><li onmouseover="changeColor5()" onmouseleave="reverseColor5()" id="sd-link5" id="sd-link" class="sd-item">NEWS</li></a>
							<a class="text-white sd-link" href="#"><li onmouseover="changeColor6()" onmouseleave="reverseColor6()" id="sd-link6" id="sd-link" class="sd-item">HELP</li></a>
							</ul>
						</div>';
			echo $sidebar;
